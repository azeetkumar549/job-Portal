	...
	<div class="form-w3layouts">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal bucket-form" method="post" action="{{route('jobs.store')}}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="application_start" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Last Date</label>
                        <div class="col-sm-6">
                            <input type="text" name="last_date" class="form-control round-input">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Salary</label>
                        <div class="col-sm-6">
                            <input class="form-control" id="focusedInput" name="salary" type="text">
                        </div>
                    </div>
                  <div class="form-group">
